...
public class TesteArrayListFundoImobiliario {
	...
	public static void main(String[] args) {
		...
		System.out.println("Data do rendimento: " + f1.getRendimentos().get(0).getRendimentoData());
		System.out.println("Valor do rendimento: R$" + f1.getRendimentos().get(0).getRendimentoValor());
	}
